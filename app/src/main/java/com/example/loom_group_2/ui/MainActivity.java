        ...
        try {
            mGoogleSignInClient.signOut().addOnCompleteListener(task -> {
                try {
                    ...
                    Toast.makeText(this, "Failed to start Google Sign-In. Ensure a Google account is added.", Toast.LENGTH_LONG).show();
                }
            });
        } catch (Exception e) {
            Log.e(TAG, "Error during Google Sign-Out/Sign-In", e);
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                if (e.getStatusCode() == 12500) {
                    message = "Google Play Services error. Ensure your emulator has Play Store.";
